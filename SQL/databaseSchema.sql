...
(
    ...
    foreign key (PAPER_ID) references REVIEW_ASSIGNMENT_DETAIL(P_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
ALTER TABLE PAPER
ADD STATUS ENUM ('UNSOLVED_REVIEW','REVIEW','RESPOND_REVIEW','COMPLETE_REVIEW','PUBLICATION','POSTED') NOT NULL DEFAULT 'UNSOLVED_REVIEW';